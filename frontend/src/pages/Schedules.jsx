...
import { roomService, deviceService, scheduleService } from '../services/api';
import { CalendarRange, Plus, Trash2, Clock, CheckSquare, Square, RefreshCw } from 'lucide-react';
...
const Schedules = () => {
  ...
  const fetchInitialData = async () => {
    ...
    try {
      ...
      console.error(err);
      setError('Failed to load schedules or classrooms.');
    } finally {
      setLoading(false);
    }
  };
