<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <button id="open-control-center-btn"
                    class="px-5 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white font-medium rounded-xl shadow-sm transition duration-150">
                    Open Control Center
                </button>
            </div>
        </div>
    ...
    <div id="control-center-modal"
        class="hidden fixed inset-0 z-50 overflow-y-auto flex items-center justify-center p-4 sm:p-6 lg:p-8">
        ...
        <div
            class="relative w-full max-w-5xl transform rounded-2xl bg-white dark:bg-gray-900 shadow-2xl transition-all border border-gray-200 dark:border-gray-800 flex flex-col max-h-[90vh]">

            <!-- Modal Header -->
            <div
                class="px-6 py-4 border-b border-gray-200 dark:border-gray-800 flex justify-between items-center bg-gray-50 dark:bg-gray-900/50 rounded-t-2xl">
                <h2
                    class="font-semibold text-xl text-gray-800 dark:text-gray-100 leading-tight flex items-center gap-2">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex items-center gap-2">
                        <label for="room-select"
                            class="text-xs font-medium text-gray-600 dark:text-gray-400">Room:</label>
                        <select id="room-select"
                            class="text-sm rounded-lg border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-100 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 dark:focus:ring-indigo-800 py-1 transition duration-150">
                            <option value="" disabled selected>Loading...</option>
                        </select>
                    </div>

                    <!-- Close Button -->
                    <button id="close-control-center-btn"
            ...
            <div class="p-6 overflow-y-auto space-y-6 custom-scrollbar">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <!-- Temperature Card -->
                    <div
                        class="relative overflow-hidden rounded-xl bg-gradient-to-br from-amber-500/10 to-orange-500/10 dark:from-amber-500/5 dark:to-orange-500/5 border border-amber-500/20 dark:border-amber-500/10 p-5 shadow-sm">
                        <div class="absolute top-0 right-0 p-3 opacity-10">
                            <svg class="w-16 h-16 text-amber-500" fill="currentColor" viewBox="0 0 24 24">
                                <path
                                    d="M12 2a3 3 0 0 0-3 3v8.17a5 5 0 1 0 6 0V5a3 3 0 0 0-3-3m0 2a1 1 0 0 1 1 1v8h-2V5a1 1 0 0 1 1-1z" />
                            </svg>
                        </div>
                        <div class="flex justify-between items-center mb-2">
                            <span
                                class="text-xs font-semibold tracking-wider text-amber-600 dark:text-amber-400 uppercase">Temperature</span>
                    ...
                    <!-- Humidity Card -->
                    <div
                        class="relative overflow-hidden rounded-xl bg-gradient-to-br from-blue-500/10 to-indigo-500/10 dark:from-blue-500/5 dark:to-indigo-500/5 border border-blue-500/20 dark:border-blue-500/10 p-5 shadow-sm">
                        <div class="absolute top-0 right-0 p-3 opacity-10">
                        ...
                        <div class="flex justify-between items-center mb-2">
                            <span
                                class="text-xs font-semibold tracking-wider text-blue-600 dark:text-blue-400 uppercase">Humidity</span>
                            <span class="flex h-2.5 w-2.5 relative">
                                <span
                        ...
                        <div class="flex items-baseline">
                            <span id="humidity-value"
                                class="text-4xl font-black text-gray-800 dark:text-gray-100">--</span>
                    ...
                    <!-- Motion Card -->
                    <div id="motion-card"
                        class="relative overflow-hidden rounded-xl bg-slate-100 dark:bg-slate-800/40 border border-gray-200 dark:border-gray-700/60 p-5 shadow-sm transition-all duration-500">
                        <div class="absolute top-0 right-0 p-3 opacity-10">
                        ...
                        <div class="flex justify-between items-center mb-2">
                            <span
                                class="text-xs font-semibold tracking-wider text-gray-600 dark:text-gray-400 uppercase">Motion
                                Status</span>
                            <span class="flex h-2.5 w-2.5 relative">
                                <span id="motion-ping"
                                    class="absolute inline-flex h-full w-full rounded-full opacity-75 bg-slate-400"></span>
                                <span id="motion-dot"
                                    class="relative inline-flex rounded-full h-2.5 w-2.5 bg-slate-500"></span>
                            </span>
                        </div>
                        <div class="flex items-center gap-3">
                            <span id="motion-value" class="text-3xl font-extrabold text-gray-800 dark:text-gray-100">No
                                Motion</span>
                        </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <!-- Device Controls -->
                    <div
                        class="bg-gray-50 dark:bg-gray-800/30 rounded-xl border border-gray-200 dark:border-gray-800 p-5">
                        ...
                        <div id="devices-container" class="space-y-3">
                            <div class="text-gray-500 dark:text-gray-400 text-xs py-4 text-center">Select a room to list
                                devices.</div>
                        </div>
                    </div>
                    ...
                    <!-- Console Logs -->
                    <div
                        class="bg-gray-50 dark:bg-gray-800/30 rounded-xl border border-gray-200 dark:border-gray-800 p-5 flex flex-col justify-between">
                        <div>
                            <h3 class="text-sm font-bold text-gray-800 dark:text-gray-100 mb-4 flex items-center gap-2">
                            ...
                            <div id="logs-container"
                                class="bg-gray-950 rounded-lg p-3 font-mono text-[11px] text-emerald-400 border border-gray-800 h-36 overflow-y-auto space-y-1 scrollbar-thin scrollbar-thumb-gray-800">
                                <div>[SYSTEM] Ready. Select a room to start monitoring.</div>
                            </div>
                        </div>
                        <div
                            class="mt-3 pt-3 border-t border-gray-200 dark:border-gray-800 flex justify-between items-center text-[11px] text-gray-500">
                            <span>Last Update: <span id="last-update-time">Never</span></span>
                            <button id="refresh-btn"
                                class="text-indigo-500 hover:text-indigo-600 dark:hover:text-indigo-400 font-semibold flex items-center gap-1">
                ...
                <div
                    class="mt-6 bg-white dark:bg-gray-800/30 border border-gray-200 dark:border-gray-800 rounded-xl p-5 shadow-sm">
                    <h3 class="text-sm font-bold text-gray-800 dark:text-gray-100 mb-4 flex items-center gap-2">
                        <svg class="w-4 h-4 text-rose-500 animate-pulse" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div id="alerts-container" class="space-y-2">
                        <div class="text-gray-500 dark:text-gray-400 text-xs py-4 text-center">Select a classroom to
                            view active alerts.</div>
                    </div>
                </div>
